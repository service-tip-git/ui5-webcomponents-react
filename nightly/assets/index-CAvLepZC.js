import{w as t}from"./iframe-CY8s9yjy.js";const e=t("ui5-li-group",["headerAccessibleName","headerText","wrappingType"],[],["header"],["move-over","move"]);e.displayName="ListItemGroup";try{e.displayName="ListItemGroup",e.__docgenInfo={description:`The \`ListItemGroup\` is a special list item, used only to create groups of list items.
