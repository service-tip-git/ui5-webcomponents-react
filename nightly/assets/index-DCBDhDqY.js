import"./CheckBox-CGo4rroA.js";import{w as n}from"./withWebComponent-DIBLIPif.js";const e=n("ui5-checkbox",["accessibleName","accessibleNameRef","name","text","valueState","wrappingType"],["checked","disabled","displayOnly","indeterminate","readonly","required"],[],["change"]);e.displayName="CheckBox";try{e.displayName="CheckBox",e.__docgenInfo={description:`Allows the user to set a binary value, such as true/false or yes/no for an item.
