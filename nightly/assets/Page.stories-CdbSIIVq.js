...
__Supported Node Type/s:__ \`Array<HTMLElement>\``,name:"header",required:!1,type:{name:"UI5WCSlotsNode"}},backgroundDesign:{defaultValue:{value:'"Solid"'},description:"Defines the background color of the `Page`.\n\n**Note:** When a ui5-list is placed inside the page, we recommend using “List” to ensure better color contrast.",name:"backgroundDesign",required:!1,type:{name:"enum",value:[{value:'"List"'},{value:'"Transparent"'},{value:'"Solid"'},{value:'"List"'},{value:'"Solid"'},{value:'"Transparent"'}]}},fixedFooter:{defaultValue:{value:"false"},description:`Defines if the footer is fixed at the very bottom of the page.
