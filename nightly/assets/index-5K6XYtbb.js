import"./TextArea-DI7NHthh.js";import{w as t}from"./iframe-BclzIqLN.js";const e=t("ui5-textarea",["accessibleDescription","accessibleDescriptionRef","accessibleName","accessibleNameRef","growingMaxRows","maxlength","name","placeholder","rows","value","valueState"],["disabled","growing","readonly","required","showExceededText"],["valueStateMessage"],["change","input","scroll","select"]);e.displayName="TextArea";try{e.displayName="TextArea",e.__docgenInfo={description:`The \`TextArea\` component is used to enter multiple rows of text.
