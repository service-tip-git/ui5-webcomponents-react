import{r as p,j as e,X as o,aI as U,p as E,aj as j,fG as _,T as c,U as t,I as D,cQ as h,M as R}from"./iframe-BWDYb3Af.js";import{f as b}from"./favorite-DBO_RmrL.js";import{s as A}from"./settings-DS_FG7pu.js";import{D as L}from"./index-Bxg6YCyu.js";import{I as k}from"./index-xDc2LBmD.js";import{M as O}from"./index-D3oK06Ge.js";import{S as M}from"./index-C2jRL8Y_.js";import{S as F}from"./index-B8fX6qdw.js";import{S as q}from"./index-gTEpRQo7.js";import{T as I}from"./index-B6QSlgiQ.js";import{u as C,a as W,b as H,c as i,T as S}from"./index-9N0g0n-w.js";const d=p.forwardRef((n,a)=>{const{children:s,...r}=n,{inPopover:l}=C();return e.jsx(o,{...r,ref:a,children:l?s:""})});d.displayName="OverflowToolbarButton";try{d.displayName="OverflowToolbarButton",d.__docgenInfo={description:"The `OverflowToolbarButton` represents a push button that shows its text only when in the overflow area of a `Toolbar`.\n\n__Note:__ This component is only compatible with the `Toolbar` component from the `@ui5/webcomponents-react-compat` package.",displayName:"OverflowToolbarButton",props:{children:{defaultValue:null,description:"Defines the text of the component which is only visible in the overflow area of a `Toolbar`.\n\n**Note:** Although this slot accepts HTML Elements, it is strongly recommended that you only use text in order to preserve the intended design.",name:"children",required:!1,type:{name:"ReactNode | ReactNode[]"}},icon:{defaultValue:null,description:`Defines the icon to be displayed as graphical element within the component. The SAP-icons font provides numerous options.
