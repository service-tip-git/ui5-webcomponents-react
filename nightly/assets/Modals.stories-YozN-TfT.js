import{j as e}from"./jsx-runtime-D6fbYt3N.js";import{M as r}from"./index-CKqKJYZy.js";import{M as l}from"./index-o9FjMx8Q.js";import{B as o}from"./index-DP-u0XOf.js";import{B as R}from"./index-Dmy9ytmu.js";import{a as D}from"./index-0YC9QbjG.js";const I={title:"User Feedback / Modals",component:r},s={render:()=>e.jsx(e.Fragment,{children:e.jsx(o,{onClick:()=>{const{close:F}=r.showDialog({headerText:"Dialog Title",children:"I'm a Dialog!",footer:e.jsx(R,{endContent:e.jsx(o,{onClick:()=>F(),children:"Close"})})})},children:"Show Dialog"})})},n={render:()=>e.jsx(e.Fragment,{children:e.jsx(o,{id:"modals-show-popover",onClick:()=>{r.showPopover({opener:"modals-show-popover",headerText:"Popover Title",children:"I'm a Popover!"})},children:"Show Popover"})})},a={render:()=>e.jsx(e.Fragment,{children:e.jsx(o,{id:"modals-show-responsive-popover",onClick:()=>{r.showResponsivePopover({opener:"modals-show-responsive-popover",headerText:"Responsive Popover Title",children:"I'm a Responsive Popover!"})},children:"Show ResponsivePopover"})})},t={render:()=>e.jsx(e.Fragment,{children:e.jsx(o,{id:"modals-show-menu",onClick:()=>{r.showMenu({opener:"modals-show-menu",headerText:"Menu Title",children:e.jsxs(e.Fragment,{children:[e.jsx(l,{text:"New File",icon:"add-document"}),e.jsx(l,{text:"New Folder",icon:"add-folder",disabled:!0})]})})},children:"Show Menu"})})},d={render:()=>e.jsx(e.Fragment,{children:e.jsx(o,{onClick:()=>{r.showMessageBox({type:D.Confirm,children:"Can you see this MessageBox?"})},children:"Show MessageBox"})})},i={render:()=>e.jsx(e.Fragment,{children:e.jsx(o,{onClick:()=>{r.showToast({children:"I'm a Message Toast!"})},children:"Show Toast"})})};var c,p,m;s.parameters={...s.parameters,docs:{...(c=s.parameters)==null?void 0:c.docs,source:{originalSource:`{
  render: () => {
    return <>
        <Button onClick={() => {
        const {
