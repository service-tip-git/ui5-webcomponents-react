import{a as e,i as t}from"./preload-helper-usAeo7Bx.js";import{$m as n,$p as r,Cm as i,Dh as a,Dm as o,Em as s,Id as c,Ld as l,Oh as u,Om as d,Op as f,Qp as p,Rh as m,Sm as h,Tm as g,Vh as _,am as v,bm as y,bp as b,ch as x,im as S,km as ee,kp as te,ng as C,nm as w,rg as T,rm as E,tm as D,vm as O,wm as k,xm as A,xp as j,ym as M}from"./iframe-D3HIhfxa.js";import{c as N,n as P,s as F,t as I,y as L}from"./parameters-bundle.css-ivWRUyAZ.js";import{n as ne,t as R}from"./paper-plane-DYiJtZQi.js";function z(){return E(`div`,{class:`ai-prompt-input-wrapper`,children:[this.label&&w(p,{for:`input`,children:this.label}),E(`div`,{class:`ai-prompt-input-form-wrapper`,children:[E(`div`,{class:`ai-prompt-inner-input-wrapper`,children:[E(c,{id:`input`,value:this.value,placeholder:this.placeholder,valueState:this.valueState,showClearIcon:this.showClearIcon,disabled:this.disabled,readonly:this.readonly,showSuggestions:this.showSuggestions,onKeyDown:this._onkeydown,onInput:this._onInnerInput,onChange:this._onInnerChange,onTypeAhead:this._onTypeAhead,children:[w(`slot`,{}),this.valueStateMessage.length>0&&w(`slot`,{name:`valueStateMessage`,slot:`valueStateMessage`})]}),this.showExceededText&&w(p,{class:`ai-prompt-input-counter`,children:this._exceededText})]}),w(b,{icon:ne,disabled:this._submitButtonDisabled,class:`ai-prompt-input-button`,design:`Emphasized`,onClick:this._onButtonClick})]})]})}var B=t((()=>{D(),r(),l(),j(),R()})),V,H=t((()=>{T(),S(),I(),C(`@ui5/webcomponents-theming`,`sap_horizon`,async()=>v),C(`@ui5/webcomponents-ai`,`sap_horizon`,async()=>P,`host`),V=`:host(:not([hidden])){display:inline-block}.ai-prompt-input-button{margin-left:.5rem;margin-top:3px}.ai-prompt-input-wrapper{display:flex;flex-direction:column;min-width:270px}.ai-prompt-input-form-wrapper{display:flex;flex:1}.ai-prompt-input-counter{font-size:.75rem;align-self:flex-end}#input{width:100%}.ai-prompt-inner-input-wrapper{display:flex;flex-direction:column;flex:1}
...
**Note:** Available since [v2.0.0](https://github.com/UI5/webcomponents/releases/tag/v2.0.0) of **@ui5/webcomponents-ai**.`,name:`valueState`,parent:{fileName:`ui5-webcomponents-react/packages/ai/dist/components/PromptInput/index.d.ts`,name:`PromptInputAttributes`},required:!1,tags:{default:`"None"`},type:{name:`enum`,raw:`"Information" | "None" | "Critical" | ValueState | "Positive" | "Negative"`,value:[{value:`"Information"`},{value:`"None"`},{value:`"Critical"`},{value:`"None"`,description:``,fullComment:`@public`,tags:{public:``}},{value:`"Positive"`,description:``,fullComment:`@public`,tags:{public:``}},{value:`"Critical"`,description:``,fullComment:`@public`,tags:{public:``}},{value:`"Negative"`,description:``,fullComment:`@public`,tags:{public:``}},{value:`"Information"`,description:``,fullComment:`@public`,tags:{public:``}},{value:`"Positive"`},{value:`"Negative"`}]}},className:{defaultValue:null,declarations:[{fileName:`ui5-webcomponents-react/packages/base/dist/internal/types/CommonProps.d.ts`,name:`CommonProps`}],description:`CSS Class Name which will be appended to the most outer element of a component.
