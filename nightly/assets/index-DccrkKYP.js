import"./TextArea-Pb_2QGLV.js";import{w as n}from"./iframe-CPcs5bjw.js";const e=n("ui5-textarea",["accessibleDescription","accessibleDescriptionRef","accessibleName","accessibleNameRef","growingMaxRows","maxlength","name","placeholder","rows","value","valueState"],["disabled","growing","readonly","required","showExceededText"],["valueStateMessage"],["change","input","scroll","select"]);e.displayName="TextArea";try{e.displayName="TextArea",e.__docgenInfo={description:`The \`TextArea\` component is used to enter multiple rows of text.
